...
activities = {
    ...
    "Soccer Team": {
        "description": "Competitive soccer team with training sessions and league matches",
        "schedule": "Tuesdays and Thursdays, 3:30 PM - 5:00 PM",
        "max_participants": 16,
        "participants": ["liam@mergington.edu", "chloe@mergington.edu"]
    },
    "Volleyball Club": {
        "description": "Learn volleyball techniques and participate in friendly competitions",
    ...
    "Photography Club": {
        "description": "Learn photography techniques and showcase creative visual work",
